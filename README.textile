...
and follow the instructions to get passenger running on your machine.  If you already ran the git_local setup task and elected to enable Basic HTTP Authentication, then your Rack configuration is already taken care of.  Simply add the virtual host to you apache2 config, and restart apache.
